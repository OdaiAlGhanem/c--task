...
namespace _21_11
{
    internal class test
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("the length of (Sunday) is :" + weekDays2[0].Substring(0, 3));
            Console.WriteLine("the length of (Monday) is :" + weekDays2[1].Substring(0, 3));
            Console.WriteLine("the length of (Tuesday) is :" + weekDays2[2].Substring(0, 3));
            Console.WriteLine("the length of (Wednsday) is :" + weekDays2[3].Substring(0, 3));
            Console.WriteLine("the length of (Thursday) is :" + weekDays2[4].Substring(0, 3));
            Console.WriteLine("the length of (Friday) is :" + weekDays2[5].Substring(0, 3));
            Console.WriteLine("the length of (Satarday) is :" + weekDays2[6].Substring(0, 3));
        }
    }
}
